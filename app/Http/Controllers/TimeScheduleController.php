...
class TimeScheduleController extends Controller
{
    ...
    {   
        ...
        return view('timeschedules.list')->with('doctor', $doctor)->with('departments', $departments);
    }
    ...
    {   
        ...
        return view('timeschedules.create')->with('departments', $departments);
    }
    ...
    public function show(TimeSchedule $timeschedule)
    {
        ...
        $users = User::find($timeschedule->user_id);
        return view('timeschedules.show')->with('timeschedule', $timeschedule)->with('users', $users);
    }
