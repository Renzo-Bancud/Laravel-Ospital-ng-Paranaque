    ...
    <div class="content-wrapper">
                    ...
                    <div class="card card-rounded" style="border:1px black dashed;">
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-between align-items-start">
                                <div>
                                    <h4 class="card-title card-title-dash">Manage Hemodialysis Categories</h4>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="javascript:void()" data-bs-toggle="modal"
                                                        ...
                                                        <a href="javascript:void()" data-bs-toggle="modal"
                                                        data-bs-target="#removecategory" data-id="{{ $category->id }}"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header p-3">
                        <h5 class="modal-title"><b>Add Hemodialysis Category</b>
                        </h5>
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{  route('hemodialysis-category-store')}}">
                            @csrf
        ...
        <div class="modal fade" id="editcategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header p-3">
                        <h5 class="modal-title"><b>Edit Hemodialysis Category</b>
                        </h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{  route('update-hemodialysis-category')}}">
                            @csrf
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-3">
                        <form method="POST" action="{{route('destroy-hemodialysis-category')}}">
                        @method('DELETE')
                        @csrf
                        <center>
