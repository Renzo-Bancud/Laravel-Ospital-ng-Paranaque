...
<div class="main-panel">
    <div class="content-wrapper">
                    ...
                    <div class="card card-rounded" style="border:1px black dashed;">
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-between align-items-start">
                                <div>
                                    <h4 class="card-title card-title-dash">Manage Radiologies</h4>
                               
                                </div>
                                <div>
                                    <a href="{{ route('radiology-category') }}"
                                        class="btn btn-dafault btn-lg mb-0 me-0">
                                        <span class="iconify fs-20" data-icon="carbon:category"></span>&nbsp;radiology
                                        categories</a>



                                    <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#addradio"
                                        class="btn btn-primary btn-lg text-white mb-0 me-0">
                                        <span class="iconify fs-20 text-white"
                                            data-icon="material-symbols:radiology-outline"></span>&nbsp;Add</a>
                                </div>
                            </div>
                            <div class="mt-1">
                                <table class="table select-table" id="data-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$radiology->category_name }}</td>
                                            <td>{{$radiology->amount}}</td>
                                            <td>{{$radiology->created_at}}</td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a href="javascript:;"
                                                        ...
                                                        data-id = "{{$radiology->id}}"
                                                        data-test = "{{$radiology->test}}"
                                                        data-category = "{{$radiology->category_id}}"
                                                        data-amount = "{{$radiology->amount}}"
                                                    ...
                                                    <a href="javascript:void()" data-bs-toggle="modal"
                                                        data-bs-target="#removeticket" data-id="{{ $radiology->id }}"
        ...
        <div class="modal fade" id="addradio" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header p-3">
                        <h5 class="modal-title"><b>Add radiology</b></h5>
        ...
        <div class="modal fade" id="edit_ticket" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header p-3">
                        <h5 class="modal-title"><b>Edit radiology</b></h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form method="POST" action="{{ route('update-radiology') }}">
                            @csrf

                            <input type="hidden" name="token" value="{{ $token }}">
                            <input type="hidden" name="radio_id" id="ticket_id">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-3">
                        <form method="POST" action="{{ route('destroy-radio') }}">
                        @method('DELETE')
                        @csrf
                        <center>
                        <input type="hidden"  name="remove_radio" id="remove_item">
