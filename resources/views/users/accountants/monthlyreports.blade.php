                    ...
                    <div class="card card-rounded" style="border:1px black dashed;">
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-between align-items-start">
                                <div>
                                    <h4 class="card-title card-title-dash">Monthly Reports</h4>
                                </div>
                                <div>
                           ...
                           <button class="btn btn-info export-btn" data-table-id="table1">
                            ...
                            <table class="table select-table export-table" id="table1">
                                ...
                                <tbody>
                                    ...
                                    @php
                                    // Check if we need to display a new month row
                                    $month = date('F Y', strtotime($laboratory->date_created));
                                    if($current_month !== $month){
                                    // If this is not the first row, output the grand total for the previous month
                                    if($current_month !== null){
                                    echo "<tr>
                                        <td style='text-align:right;' colspan=\"5\"><strong>MONTHLY GRAND TOTAL:</strong></td>
                                        <td>$format_total</td>
                                    </tr>";
                                    }
                                    // Reset the grand total and update the current month
                                    $grand_total = 0;
                                    $current_month = $month;
                                    // Add a row for the month header
                                    echo "<tr class=\"month-header\" data-month=\"$current_month\">
                                                <td colspan=\"6\"><strong>$current_month</strong></td>
                                        </tr>";
                                    }
                                    ...
                                    @endphp
                                    <tr class="month-data" data-month="{{$month}}">
                                        <td>
                                            <p>{{$laboratory->test}}</p>
                                        </td>
                                        <td>
                        ...
                        <div id="pharmacy_report" style="display:none;">
                            ...
                            <table class="table select-table export-table" id="table2">
                                ...
                                <tbody>
                                    ...
                                    @php
                                    // Check if we need to display a new month row
                                    $month = date('F Y', strtotime($pharmacy->date_created));
                                    if($current_month !== $month){
                                    // If this is not the first row, output the grand total for the previous month
                                    if($current_month !== null){
                                    echo "<tr>
                        ...
                        <button class="btn btn-info export-btn" data-table-id="table3">
                            ...
                            <table class="table select-table export-table" id="table3">
                                ...
                                <tbody>
                                    ...
                                    @php
                                    // Check if we need to display a new month row
                                    $month = date('F Y', strtotime($radiology->date_created));
                                    if($current_month !== $month){
                                    // If this is not the first row, output the grand total for the previous month
                                    if($current_month !== null){
                                    echo "<tr>
                        ...
                        <button class="btn btn-info export-btn" data-table-id="table4">
                            ...
                            <table class="table select-table export-table" id="table4">
                                ...
                                <tbody>
                                    ...
                                    @php
                                    // Check if we need to display a new month row
                                    $month = date('F Y', strtotime($dialysis->date_created));
                                    if($current_month !== $month){
                                    // If this is not the first row, output the grand total for the previous month
                                    if($current_month !== null){
                                    echo "<tr>
