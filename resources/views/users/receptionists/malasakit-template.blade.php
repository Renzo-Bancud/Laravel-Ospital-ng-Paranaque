                            ...
                            <div class="contain">
                                ...
                                <div class="flex-inputs">
                                    <div style="width:60%;" class="inline-input">
                                        <span style="width:285px;" class="uppercase">Name</span><span>:</span><input class="print-input">
                                    </div>

                                    <div style="width:20%;" class="inline-input">
                                        <span class="uppercase">Age</span><span>:</span><input class="print-input">
                                    </div>

                                    <div style="width:20%;" class="inline-input">
                                        <span class="uppercase">Gender</span><span>:</span><input class="print-input" >
                                    </div>
                                </div>
                                ...
                                <div class="flex-inputs">
                                    <div style="width:80%;" class="inline-input">
                                        <span style="width:260px;" class="uppercase">Address</span><span>:</span><input class="print-input" >
                                    </div>
...
<!-- 
                                <div class="flex-inputs">
    <div style="width:100%;" class="inline-input">
        <span class="uppercase" style="width:192px;text-align:right;">
            Care Of&nbsp;&nbsp;</span><span>:</span>
        <div>
            <span><input type="checkbox">&nbsp;OMOE</span>
            &nbsp;
            <span><input type="checkbox">&nbsp;DOH-MAIP</span>
            <br>
            <br>
            <span><input type="checkbox">&nbsp;PCSO</span>
            &nbsp;&nbsp;&nbsp;
            <span><input type="checkbox">&nbsp;OP-SCPF</span><br><br>
            <input class="print-input">
        </div>
    </div>
</div> -->
                            ...
                            <div class="contain" style="margin-top:10px;">
                                ...
                                <div class="flex-inputs" style="margin-top:20px;">
                                    <div style="width:70%;" class="inline-input">
                                        <span style="width:170px">This is to certify that</span><input class="print-input">
                                    </div>
                                    <div style="width:30%;" class="inline-input">
                                        <span>of</span><input class="print-input">
                                    </div>
                                </div>
                            ...
                            <div class="contain" style="margin-top:10px;" p>
                                ...
                                <div class="flex-inputs" style="margin-top:20px;">
                                    <div style="width:70%;" class="inline-input">
                                        <span style="width:50px;margin-left:20px;">Ako si</span><input class="print-input">,
                                    </div>
                                    <div style="width:30%;" class="inline-input">
                                        <input class="print-input"><span style="width:190px">taong gulang</span>
                                    </div>
                                </div>

                                <div class="flex-inputs">
                                    <div style="width:100%;" class="inline-input">
                                        <span style="width:180px">nakatira sa</span><input class="print-input"> <span style="width:870px">ay nagpapatunay na ang sumusunod na pamamaraan</span>
                                    </div>
                                </div>
                                <div class="flex-inputs">
