...
<div class="main-panel">
    <div class="content-wrapper">
                    ...
                    <div class="card card-rounded" style="border:1px black dashed;">
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-between align-items-start">
                                <div>
                                    <h4 class="card-title card-title-dash">Manage Pharmacies</h4>
                                
                                </div>
                                <div>
                                    <a href="{{ route('pharmacy-category') }}"
                                        class="btn btn-dafault btn-lg mb-0 me-0">
                                        <span class="iconify fs-20" data-icon="carbon:category"></span>&nbsp;pharmacy
                                        categories</a>



                                    <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#addPharmacy"
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a href="javascript:;"
                                                        ...
                                                        data-id = "{{$pharmacy->id}}"
                                                        data-test = "{{$pharmacy->medicine}}"
                                                        data-category = "{{$pharmacy->category_id}}"
                                                    ...
                                                    <a href="javascript:void()" data-bs-toggle="modal"
                                                        data-bs-target="#removeticket" data-id="{{ $pharmacy->id }}"
        ...
        <div class="modal fade" id="addPharmacy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header p-3">
                        <h5 class="modal-title"><b>Add Pharmacy</b></h5>
                        ...
                        <form method="POST" action="{{route('pharmacies.store')}}">
                            ...
                            <div class="form-group row" style="margin-bottom:-3px;">
                                <label for="inputRequest" class="col-sm-4 col-form-label"
                                    style="position:relative;top:-10px;">Medicne Name:</label>
                                <div class="col-sm-8">
        ...
        <div class="modal fade" id="edit_ticket" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header p-3">
                        <h5 class="modal-title"><b>Edit Pharmacy</b></h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form method="POST" action="{{ route('update-pharmacy') }}">
                            @csrf

                            <input type="hidden" name="token" value="{{ $token }}">
                            <input type="hidden" name="pharmacy_id" id="ticket_id">

                            <div class="form-group row" style="margin-bottom:-3px;">
                                <label for="inputRequest" class="col-sm-4 col-form-label"
                                    style="position:relative;top:-10px;">Medicine Name:</label>
                                <div class="col-sm-8">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-3">
                        <form method="POST" action="{{ route('destroy-pharmacy') }}">
                        @method('DELETE')
                        @csrf
                        <center>
