...
<div class="main-panel">
    <div class="content-wrapper">
                    ...
                    <div class="card card-rounded" style="border:1px black dashed;">
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-between align-items-start">
                                <div>
                                    <h4 class="card-title card-title-dash">Manage Laboratories</h4>
                                    <p class="card-subtitle card-subtitle-dash">List of created laboratories</p>
                                </div>
                                <div>
                                    <a href="{{route('laboratory-category')}}"
                                        class="btn btn-dafault btn-lg mb-0 me-0">
                                        <span class="iconify fs-20" data-icon="carbon:category"></span>&nbsp;Laboratory
                                        categories</a>



                                    <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#addlab"
                                        class="btn btn-primary btn-lg text-white mb-0 me-0">
                                        <span class="iconify fs-20 text-white"
                                            data-icon="ps:lab"></span>&nbsp;Add</a>
                                </div>
                            </div>
                            <div class="mt-1">
                                <table class="table select-table" id="data-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$laboratory->category_name }}</td>
                                            <td>{{$laboratory->amount}}</td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a href="javascript:;"
                                                        ...
                                                        data-test = "{{$laboratory->test}}"
                                                        data-category = "{{$laboratory->category_id}}"
                                                        data-amount = "{{$laboratory->amount}}"
                                                    ...
                                                    <a href="javascript:void()" data-bs-toggle="modal"
                                                        data-bs-target="#removeticket" data-id="{{ $laboratory->id }}"
        ...
        <div class="modal fade" id="addlab" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header p-3">
                        <h5 class="modal-title"><b>Add Laboratory</b></h5>
        ...
        <div class="modal fade" id="edit_ticket" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header p-3">
                        <h5 class="modal-title"><b>Edit Laboratory</b></h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form method="POST" action="{{route('update-laboratory')}}">
                            @csrf

                            <input type="hidden" name="token" value="{{ $token }}">
                            <input type="hidden" name="lab_id" id="ticket_id">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-3">
                        <form method="POST" action="{{ route('destroy-lab') }}">
                        @method('DELETE')
                        @csrf
                        <center>
                        <input type="hidden"  name="remove_lab" id="remove_item">
